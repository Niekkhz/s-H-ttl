  ...
  return (
    <div className="home-background">
      <div className="container">
        <h2>Willkommen zu unserem Restaurant</h2>
        <div className="info-boxes">
          <div className="info-box">
            <h3>Öffnungszeiten</h3>
            <p>Montag: Geschlossen</p>
            <p>Dienstag: 16:00 - 00:00</p>
            <p>Mittwoch: 16:00 - 22:00</p>
            <p>Donnerstag: 16:00 - 00:00</p>
            <p>Freitag: 16:00 - 00:00</p>
            <p>Samstag: 09:00 - 00:00</p>
            <p>Sonntag: 09:00 - 00:00</p>
            <h3>Kontakt</h3>
            <p>Adresse: Hofmarkstraße 51, 82152 Planegg</p>
            <p>Telefon: 089 / 8001111</p>
